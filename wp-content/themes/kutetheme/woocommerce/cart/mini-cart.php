...
<div class="widget_shopping_cart_content">
    ...
    <div id="cart-block" class="shopping-cart-box col-xs-5 col-sm-5 col-md-2">
        <a class="cart-link" href="<?php echo esc_url( $cart_url ); ?>">
            <span class="title"><?php esc_html_e( 'Giỏ Hàng', 'kutetheme' ); ?></span>
            <span class="total"><?php echo sprintf ( _n( '%d sp', '%d sp', esc_attr( $cart_count ), 'kutetheme' ), esc_attr( $cart_count ) ) ?></span>
